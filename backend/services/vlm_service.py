...
class VlmService:
    ...
    def generate_answer(self, question: str, context_chunks: list[dict]) -> Optional[str]:
        """
        Generate a Vietnamese answer from retrieved textbook chunks using Gemini.

        Args:
            question: The student's question in Vietnamese
            context_chunks: List of dicts with 'text', 'metadata' (grade, subject, chapter, page_number)
